...
export function FighterImageCropUploader({ value, onChange }: FighterImageCropUploaderProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <Label htmlFor="fighter-image">Fighter Image</Label>
        <Input id="fighter-image" type="file" accept="image/*" onChange={handleFileUpload} />
      </div>
      ...
      {value ? (
        ...
        <div className="text-muted-foreground flex h-40 w-40 items-center justify-center rounded-lg border border-dashed text-xs">
