...
description: "Comprehensive instructions for working with the Fantasy MMA League codebase in antigravity IDE"
---

# Fantasy MMA League - Antigravity Instructions

## Project Overview

This is a Next.js App Router-based Fantasy MMA League platform with both admin and user landing pages. The codebase uses TypeScript, React, TailwindCSS, shadcn/ui, and TanStack Query for state management and data fetching.
