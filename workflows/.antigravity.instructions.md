...
description: "Comprehensive instructions for working with the Fantasy UFC League codebase in antigravity IDE"
---

# Fantasy UFC League - Antigravity Instructions

## Project Overview

This is a Next.js App Router-based Fantasy UFC League platform with both admin and user landing pages. The codebase uses TypeScript, React, TailwindCSS, shadcn/ui, and TanStack Query for state management and data fetching.
